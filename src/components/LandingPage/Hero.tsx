...
//     // >
//     <section className="px-6 sm:px-10 md:px-24 lg:px-28 py-14 md:py-24">
//       {/* <div className="md:grid md:gap-8 md:grid-cols-5 md:items-center"> */}
//       <div className="px-6 sm:px-10 md:px-24 lg:px-28">
//         <div className="md:grid md:gap-8 md:grid-cols-5 md:items-center flex">
//           {/* Mobile Image */}
...
//                 <button
//                   type="button"
//                   className="border border-solid font-semibold bg-transparent cursor-pointer rounded-sm px-5 py-3.5 text-[#6B46C1] 
//                   border-[#6B46C1] hover:text-indigo-900 hover:border-indigo-900"
  ...
  return (
    ...
    >
      <div className="md:grid md:gap-8 md:grid-cols-5">
        ...
        {/* Desktop Image */}
        <article className="self-center hidden justify-self-end md:block md:mb-0 md:col-start-4 md:col-end-6 md:w-[85%] lg:w-[60%] transition-all"
        // style={{width: "50%"}}
        >
          <div className="relative w-full hero-blob-container">
            <img alt="hero illustration" src={heroImg} className="w-full h-auto hero-drop-shadow" />
          </div>
        </article>
      </div>

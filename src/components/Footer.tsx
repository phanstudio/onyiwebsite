  ...
  return (
    <footer className="w-full py-12 text-center">
      ...
      <div className="block md:hidden">
        <ul className="w-full p-0 m-0 mb-8 list-none">
          {socials.map((s) => (
            <li key={s.name} className="inline-block w-5 sm:w-6 mx-2.5 sm:mx-4">
              <a
                href={s.href}
                target="_blank"
              ...
              >
                {/* match “icon is the thing” behavior */}
                <span className="block w-full [&>svg]:w-full [&>svg]:h-auto [&>svg]:fill-current text-[#0E1526]">
                  {s.svg}
                </span>
              </a>
            </li>
      ...
      <p className="text-sm text-[#0E1526]">©2026 Adeola J. Adeyemo</p>
    </footer>
  );
}
